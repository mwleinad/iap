                        ...
                        <td style="font-family:verdana">
                            <div style="padding-left:40px; padding-right:25px; font-size:16px;">
                                ...
                                <p style="text-align:justify; padding-bottom:20px;">
                                    Que la <strong>C. ' . mb_strtoupper($alumno['names']) . ' ' . mb_strtoupper($alumno['lastNamePaterno']) . ' ' . mb_strtoupper($alumno['lastNameMaterno']) . '</strong>, fue evaluada por esta Entidad en el estándar <strong>"' . $curso['name'] . '"</strong> con resultado de <strong>"Competente"</strong>
                                </p> 
                                <p style="text-align:justify; padding-bottom:20px;">
