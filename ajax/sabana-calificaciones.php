...
exit; */
//$fileName = 'sabana.xls';
//echo DOC_ROOT . '/images/new/docs/logoChiapas.png'; exit;

// Add some data
//$spreadsheet->setActiveSheetIndex(0);
/* $spreadsheet->setActiveSheetIndex(0)
    ->setCellValue('AB2', 'HOMBRES')
    ->setCellValue('AC2', 'MUJERES')
    ->setCellValue('AD2', 'TOTAL')
    ->setCellValue('E9', 'ESCUELA')
    ->setCellValue('E10', 'LOCALIDAD')
    ->setCellValue('E11', 'MUNICIPIO')
    ->setCellValue('E12', 'MODALIDAD'); */
// Funcion para generar estilos
function CellStyle($fontSize, $fontName, $fontBold, $borderType, $borderStyle, $vAlignment, $hAlignment, $textRotation)
{
    /**
     * $fontBold = true | false
...
for($iteration = 1; $iteration <= $totalPages; $iteration++)
{
    ...
    $sheet->getRowDimension('17')->setRowHeight(98, 'pt');
    ...
    $sheet->getStyle('G2:O2')->applyFromArray(CellStyle(11, 'Arial', true, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('G3:O3');
    $sheet->setCellValue('G3', 'SECRETARÍA DE EDUCACIÓN');
    $sheet->getStyle('G3:O3')->applyFromArray(CellStyle(11, 'Arial', true, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('G4:O4');
    $sheet->setCellValue('G4', 'SUBSECRETARÍA DE EDUCACIÓN ESTATAL');
    $sheet->getStyle('G4:O4')->applyFromArray(CellStyle(11, 'Arial', true, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('G5:O5');
    $sheet->setCellValue('G5', 'DIRECCIÓN DE EDUCACIÓN SUPERIOR');
    $sheet->getStyle('G5:O5')->applyFromArray(CellStyle(11, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('G6:O6');
    $sheet->setCellValue('G6', 'REGISTRO DE CALIFICACIÓN');
    $sheet->getStyle('G6:O6')->applyFromArray(CellStyle(11, 'Arial', true, 'none', 'thin', 'center', 'center', 0));
    $drawing2 = new Drawing();
    $drawing2->setWorksheet($sheet);
    $drawing2->setName('Logo IAP');
    $drawing2->setPath(DOC_ROOT . '/images/new/docs/logoIap.jpg');
    $drawing2->setHeight(80);
    $drawing2->setCoordinates('R2');

    // Datos Generales
    $sheet->setCellValue('E9', 'ESCUELA');
    $sheet->getStyle('E9')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('F9:S9');
    $sheet->setCellValue('F9', 'INSTITUTO DE ADMINISTRACIÓN PÚBLICA DEL ESTADO DE CHIAPAS');
    $sheet->getStyle('F9:S9')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('U9:V9');
    $sheet->setCellValue('U9', 'CLAVE');
    $sheet->getStyle('U9:V9')->applyFromArray(CellStyle(8, 'Arial', false, 'bottom', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('W9:Y9');
    $sheet->setCellValue('W9', $myInstitution['identifier']);
    $sheet->getStyle('W9:Y9')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->setCellValue('E10', 'LOCALIDAD');
    $sheet->getStyle('E10')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('F10:H10');
    $sheet->setCellValue('F10', 'TUXTLA GUTIERREZ');
    $sheet->getStyle('F10:H10')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('I10:K10');
    $sheet->setCellValue('I10', $courseInfo['majorName'] . ' EN');
    $sheet->getStyle('I10')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('L10:S10');
    $sheet->setCellValue('L10', $courseInfo['name']);
    $sheet->getStyle('L10:S10')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('U10:V10');
    $sheet->setCellValue('U10', 'RVOE');
    $sheet->getStyle('U10:V10')->applyFromArray(CellStyle(8, 'Arial', false, 'bottom', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('W10:Y10');
    $sheet->setCellValue('W10', $courseInfo['rvoe']);
    $sheet->getStyle('W10:Y10')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->setCellValue('E11', 'MUNICIPIO');
    $sheet->getStyle('E11')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('F11:H11');
    $sheet->setCellValue('F11', 'TUXTLA GUTIERREZ');
    $sheet->getStyle('F11:H11')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('I11:K11');
    $sheet->setCellValue('I11', 'CICLO ESCOLAR');
    $sheet->getStyle('I11')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('L11:N11');
    $sheet->setCellValue('L11', $courseInfo['scholarCicle']);
    $sheet->getStyle('L11:N11')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('O11:Q11');
    $sheet->setCellValue('O11', mb_strtoupper($courseInfo['tipoCuatri']));
    $sheet->getStyle('O11:Q11')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'left', 0));
    $sheet->setCellValue('R11', $period);
    $sheet->getStyle('R11')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('S11:T11');
    $sheet->setCellValue('S11', 'GRUPO');
    $sheet->getStyle('S11:T11')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'left', 0));
    $sheet->setCellValue('U11', $courseInfo['group']);
    $sheet->getStyle('U11')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('V11:W11');
    $sheet->setCellValue('V11', 'TURNO');
    $sheet->getStyle('V11:W11')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('X11:Z11');
    $sheet->setCellValue('X11', $courseInfo['turn']);
    $sheet->getStyle('X11:Z11')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('AA10:AE11');
    $sheet->setCellValue('AA10', 'A PARTIR DEL ' . $util->FormatReadableDate($courseInfo['fechaRvoe']));
    $sheet->getStyle('AA10:AE11')->applyFromArray(CellStyle(7, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->setCellValue('E12', 'MODALIDAD');
    $sheet->getStyle('E12')->applyFromArray(CellStyle(8, 'Arial', false, 'none', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('F12:H12');
    $sheet->setCellValue('F12', $modality);
    $sheet->getStyle('F12:H12')->applyFromArray(CellStyle(8, 'Arial', true, 'bottom', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('K12:U12');
    $sheet->setCellValue('K12', $util->DeterminePeriod($courseModules[0]['initialDate'], $typeCourse));
    $sheet->getStyle('K12:U12')->applyFromArray(CellStyle(9, 'Arial', true, 'bottom', 'thin', 'center', 'center', 0));

    // Datos Estadisticos
    $sheet->mergeCells('Z1:AD1');
    $sheet->setCellValue('Z1', 'DATOS ESTADISTICOS');
    $sheet->getStyle('Z1:AD1')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('Z2:AA4');
    $sheet->setCellValue('Z2', 'CONCEPTO');
    $sheet->getStyle('Z2:AA4')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('AB2:AB4');
    $sheet->setCellValue('AB2', 'HOMBRES');
    $sheet->getStyle('AB2:AB4')->applyFromArray(CellStyle(5, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    $sheet->mergeCells('AC2:AC4');
    $sheet->setCellValue('AC2', 'MUJERES');
    $sheet->getStyle('AC2:AC4')->applyFromArray(CellStyle(5, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    $sheet->mergeCells('AD2:AD4');
    $sheet->setCellValue('AD2', 'TOTAL');
    $sheet->getStyle('AD2:AD4')->applyFromArray(CellStyle(5, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    $sheet->mergeCells('Z5:AA6');
    $sheet->setCellValue('Z5', 'INSCRITOS INICIO DE CURSOS');
    $sheet->getStyle('Z5:AA6')->applyFromArray(CellStyle(6, 'Arial', false, 'allBorders', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('AB5:AB6');
    $sheet->setCellValue('AB5', '');
    $sheet->getStyle('AB5:AB6')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('AC5:AC6');
    $sheet->setCellValue('AC5', '');
    $sheet->getStyle('AC5:AC6')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('AD5:AD6');
    $sheet->setCellValue('AD5', '');
    $sheet->getStyle('AD5:AD6')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('Z8:AA9');
    $sheet->setCellValue('Z8', 'FIN DE CURSOS');
    $sheet->getStyle('Z8:AA9')->applyFromArray(CellStyle(6, 'Arial', false, 'allBorders', 'thin', 'center', 'left', 0));
    $sheet->mergeCells('AB8:AB9');
    $sheet->setCellValue('AB8', '');
    $sheet->getStyle('AB8:AB9')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('AC8:AC9');
    $sheet->setCellValue('AC8', '');
    $sheet->getStyle('AC8:AC9')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('AD8:AD9');
    $sheet->setCellValue('AD8', '');
    $sheet->getStyle('AD8:AD9')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));

    // Tabla Principal (Calificaciones)
    $sheet->mergeCells('A15:A18');
    $sheet->setCellValue('A15', 'NÚMERO PROGRESIVO');
    $sheet->getStyle('A15:A18')->applyFromArray(CellStyle(6, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    $sheet->mergeCells('B15:C18');
    $sheet->setCellValue('B15', 'CURP');
    $sheet->getStyle('B15:C18')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('D15:D18');
    $sheet->setCellValue('D15', 'CLAVE D S.E. ');
    $sheet->getStyle('D15:D18')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    $sheet->mergeCells('E15:G17');
    $sheet->setCellValue('E15', 'NOMBRE DEL ALUMNO');
    $sheet->getStyle('E15:G17')->applyFromArray(CellStyle(10, 'Arial', true, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->setCellValue('E18', 'APELLIDO PATERNO');
    $sheet->getStyle('E18')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->setCellValue('F18', 'APELLIDO MATERNO');
    $sheet->getStyle('F18')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->setCellValue('G18', 'NOMBRE (S)');
    $sheet->getStyle('G18')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('H15:H18');
    $sheet->setCellValue('H15', 'SEXO');
    $sheet->getStyle('H15:H18')->applyFromArray(CellStyle(6, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    $sheet->mergeCells('I15:P15');
    $sheet->setCellValue('I15', 'CALIFICACIONES FINALES');
    $sheet->getStyle('I15:P15')->applyFromArray(CellStyle(8, 'Arial', true, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('Q15:AB15');
    $sheet->setCellValue('Q15', 'CALIFICACIONES DE REGULARIZACIÓN');
    $sheet->getStyle('Q15:AB15')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
    $sheet->mergeCells('AC15:AC18');
    $sheet->setCellValue('AC15', 'ASIGNATURAS NO ACREDITADAS');
    $sheet->getStyle('AC15:AC18')->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    $sheet->mergeCells('AD15:AD18');
    $sheet->setCellValue('AD15', 'SITUACIÓN ESCOLAR');
    $sheet->getStyle('AD15:AD18')->applyFromArray(CellStyle(7, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
    ...
    for($noItem = 1; $noItem <= $maxStudents; $noItem++)
    {
        ...
        $sheet->getStyle($column . $noRow)->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
        // CURP
        $mergeCells = ++$column . $noRow . ':' . ++$column . $noRow;
        $sheet->mergeCells($mergeCells);
        $sheet->setCellValue($column . $noRow, '');
        $sheet->getStyle($mergeCells)->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
        // Matricula
        $sheet->setCellValue(++$column . $noRow, '');
        $sheet->getStyle($column . $noRow)->applyFromArray(CellStyle(8, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 0));
        // Apellido Paterno
    ...
    foreach($courseModules as $item)
    {
        ...
        $sheet->getStyle($beginColumn . '16:' . $beginColumn . '18')->applyFromArray(CellStyle(6, 'Arial', false, 'allBorders', 'thin', 'center', 'center', 90));
        $noColumn++;
        $beginColumn++;
    }
