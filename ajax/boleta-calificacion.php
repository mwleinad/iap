...
$qualification = $student->GetQualifications($_GET['id']);
$course->setCourseId($qualification['courseId']);
...
$modules_qualifications_tmp = json_decode($qualification['qualifications']);
$modules_qualifications = [];
foreach($modules_qualifications_tmp as $item)
    $modules_qualifications[$item->courseModule] = $item;
            ...
            <body>
                ...
                <table align='center' width='100%' border='1' class='txtTicket'>
                    ...
                    <tr>
                        ...
                        <td class='text-center'><b>Ciclo:</b> " . $qualification['cycle'] . "</td>
                    </tr>
                    <tr>
