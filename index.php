...
//$mensaje = "<strong>Estimados(as) estudiantes,</strong><p>Reciban un cordial saludo. En el IAP Chiapas nos sentimos orgullosos de acompañarlos en su formación profesional y reconocemos el esfuerzo y compromiso que han demostrado en su desarrollo académico.</p><p>Como parte de nuestra misión de brindarles un servicio educativo de calidad, es fundamental contar con la participación de todos para asegurar la continuidad y excelencia de este proyecto de profesionalización. Una de las formas de contribuir a ello es cumpliendo con las obligaciones administrativas en tiempo y forma.</p><p>Por ello, les informamos que, a partir de ahora, los pagos deberán realizarse al inicio de cada materia, contando con un plazo de hasta 7 días adicionales para completarlo. En el caso de inicio de periodo, además de la inscripción o reinscripción, también deberán cubrir el pago correspondiente a la primera materia.</p><p>Hasta el momento, la plataforma ha permanecido activa sin restricciones, permitiendo una mejor adaptación al entorno virtual. Sin embargo, les pedimos que tomen en cuenta que, a partir del 3 de febrero, se activará el bloqueo de acceso en caso de pagos pendientes.</p><p>Para realizar sus pagos y planificar los próximos, por favor ingresen al panel de Finanzas dentro de esta plataforma o utilicen el siguiente enlace <a href='https://app.iapchiapas.edu.mx/finanzas'>https://app.iapchiapas.edu.mx/finanzas</a> <br>Si tienes alguna duda con respecto al proceso de pago, puedes consultar el siguiente enlace: <a href='https://app.iapchiapas.edu.mx/pdf/Finanzas.pdf' target='_blank'>https://app.iapchiapas.edu.mx/pdf/Finanzas.pdf</a></p><p>Les agradecemos su comprensión y colaboración.</p>";
//Bloqueo por pago
