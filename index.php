...
if ($User) {
	...
	if ($estudiantePromo[0]['controlNumber']) {
		...
		$smarty->assign("promo", false);
		$smarty->assign("mensajePromo", $mensajePromo);
	}
}
//$mensaje = "<strong>Estimados(as) estudiantes,</strong><p>Como parte del compromiso adquirido al formar parte de la Maestría en Administración y Políticas Públicas, su participación es clave para garantizar la continuidad y excelencia de este proyecto de profesionalización.</p><p>Entendemos que algunos(as) de ustedes han enfrentado dificultades para realizar sus primeros pagos, correspondientes a la inscripción y la primera materia. Con el objetivo de apoyarlos en su proceso formativo, se ha decidido extender, por única ocasión, el plazo para cumplir con estas obligaciones hasta el <strong>07 de febrero</strong>. A partir de esta fecha, el acceso a las actividades escolares en la plataforma educativa será restringido.</p><p>Sabemos que combinar estudios con otras responsabilidades no es una tarea sencilla, pero también reconocemos su esfuerzo y determinación para avanzar en su desarrollo profesional y personal. Este camino, aunque desafiante, traerá consigo grandes satisfacciones y nuevas oportunidades.</p><p>Los invitamos a seguir adelante con este valioso proyecto y a aprovechar al máximo esta experiencia de aprendizaje. Agradecemos su compromiso y esperamos contar con su participación activa.</p> <p>Para realizar sus pagos y planificar los próximos, por favor ingresen al panel de finanzas ubicado dentro de esta plataforma, o utilicen el siguiente enlace: <a href='https://app.iapchiapas.edu.mx/finanzas'>https://app.iapchiapas.edu.mx/finanzas</a></p><p>Si tienes duda respecto del proceso de pago puedes consultar la siguiente guía: <a href='https://app.iapchiapas.edu.mx/pdf/Finanzas.pdf' target='_blank'>https://app.iapchiapas.edu.mx/pdf/Finanzas.pdf</a></p><p>Les agradecemos su colaboración y comprensión.</p><p>Atentamente</p><p>Dirección Académica</p>";
//Bloqueo por pago
