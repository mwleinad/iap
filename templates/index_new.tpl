...
<body>
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			{else}
				{if (($User.type ne "Docente") and ($User.type ne "student") and !in_array($page, ["register", "registro", "registro-cobach", "verificar", "registro-INAI"]))}
			...
			<div class="main-panel"
				{if (($User.type eq "Docente") or ($User.type eq "student") or in_array($page, ["register", "registro", "registro-cobach", "verificar", "registro-INAI"]))}
