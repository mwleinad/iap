...
<body>
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			{else}
				{if (($User.type ne "Docente") and ($User.type ne "student") and ($page ne "register") and ($page ne "registro") and $page ne "registro-cobach") and $page ne "verificar"}
			...
			<div class="main-panel"
				{if (($User.type eq "Docente") or ($User.type eq "student") or ($page eq "register") or ($page eq "registro") or $page eq "registro-cobach") or $page eq "verificar"}
