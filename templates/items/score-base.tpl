    ...
    {if $mostrar == 1}
        <tr id="1">
            ...
            <td class="text-center" id='test{$item.activityScoreId}'>
                <input type="text" class="form-control" maxlength="5" size="5"  name="ponderation[{$item.alumnoId}]" value="{$item.ponderation}" {(in_array($item.alumnoId,[4405, 4404, 4336, 4531, 4548, 4549, 4550, 4568, 4570, 4576, 3983, 7098])) ? 'disabled' : ''} />
