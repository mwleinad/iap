...
{foreach from=$subjects item=subject}
	{if $item.subjectId eq $subject.subjectId}
		<tr>
			...
			<td class="text-center">{if $subject.modality eq 'Local'}Escolar{elseif $subject.modality eq 'Online'}No Escolar{else}Mixta{/if}</td>
				...
				<td class="text-center">
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							...
							<a class="dropdown-item" href="{$WEB_ROOT}/graybox.php?page=constancias&id={$subject.courseId}" data-target="#ajax" data-toggle="modal" title="Constancias" data-width="1100px">
