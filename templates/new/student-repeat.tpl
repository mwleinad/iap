    ...
    <div class="card-body">
        <form id="frmAddCurricula" name="frmAddCurricula" method="post" onsubmit="return false">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <label for="courseId"><span class="text-danger">*</span> Selecciona Curricula:</label>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="courseModuleId" id="courseModuleId" class="form-control">
                        <option value=""></option>
                    </select>
                </div>
            </div>
        ...
        <div class="row">
            <div class="form-group col-md-12 text-center">
                ...
                <button  class="btn btn-success submitForm" onClick="addModuls()">Asignar Módulo</button>
            </div>	
        </div>
    </div>
</div>
