...
<head>
    ...
    <link href="{$WEB_ROOT}/assets/pages/css/login-5.min.css" rel="stylesheet" type="text/css" />
...
<script src="{$WEB_ROOT}/assets/pages/scripts/login-5.min.js" type="text/javascript"></script>
