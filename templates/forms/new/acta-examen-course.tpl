<form action="{$WEB_ROOT}/ajax/acta-examen.php" method="POST" target="_blank">
    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="noAutorizacion" id="noAutorizacion" class="form-control" required />
        </div>
    </div>
    ...
    <div class="row d-flex justify-content-center">
        <div class="form-group col-md-12">
            ...
            <input type="text" name="tesis" id="tesis" class="form-control" required />
        </div>
    </div>
    ...
    <div class="row d-flex justify-content-center">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="nombrePresidente" id="nombrePresidente" class="form-control" required />
        </div>
        <div class="form-group col-md-6">
            <label for="cedulaPresidente">Cédula del Presidente</label>
            <input type="text" name="cedulaPresidente" id="cedulaPresidente" class="form-control" required />
        </div>
    </div>
