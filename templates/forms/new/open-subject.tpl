<form class="form" id="form_modal" method="post" action="{$WEB_ROOT}/open-subject">
        ...
        <div class="form-group col-md-4">
            ...
            <select name="personalId" id="personalId" class="form-control">
                ...
                {foreach from=$empleados item=personal}
                    <option value="{$personal.personalId}" {($personal.personalId == 114) ? "selected" : ""}>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <label for="temporalGroup">Grupo Temporal <small>(Seleccione si se trata de un grupo
                    oficial)</small>:</label>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="checkbox" checked name="apareceT" id="apareceT" class="form-control" readonly/>
        </div>
