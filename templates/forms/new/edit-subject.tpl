<form id="editSubjectForm" name="editSubjectForm" method="post" action="{$WEB_ROOT}/edit-subject/id/{$post.subjectId}">
        ...
        <div class="form-group col-md-4">
            ...
            <select name="tipo" id="tipo" class="form-control">
                {foreach from=$major item=item}
                    <option value="{$item.majorId}" {if $post.tipo == $item.majorId} selected="selected" {/if}>{$item.name}
                    </option>
                {/foreach}
            </select>
        </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="fechaRvoe" id="fechaRvoe" value="{$post.fechaRvoe}"
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="fechaRvoeLinea" id="fechaRvoeLinea" value="{$post.fechaRvoeLinea}"
                class="form-control i-calendar" />
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="totalPeriods" id="totalPeriods" class="form-control"
                value="{$post.totalPeriods}" />
        </div>
        <div class="form-group col-md-4">
            <label for="constancia">¿Genera constancia de alineación?</label>
            <select class="form-control" id="constacia" name="constancia">
                <option value="0">No</option>
                <option value="1" {($post.constancia == 1) ? "selected" : ""}>Sí</option>
            </select>
        </div>
        <div class="form-group col-md-4">
            <label for="vigencia">Días de vigencia de la constacia</label>
            <input type="text" name="vigencia" id="vigencia" class="form-control" value="{$post.vigencia}"/>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <textarea id="welcomeText" name="welcomeText" rows="15" cols="80"
                class="form-control">{$post.welcomeText}</textarea>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <textarea id="introduction" name="introduction" rows="15" cols="80"
                class="form-control">{$post.introduction}</textarea>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <textarea id="intentions" name="intentions" rows="15" cols="80"
                class="form-control">{$post.intentions}</textarea>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <textarea id="objectives" name="objectives" rows="15" cols="80"
                class="form-control">{$post.objectives}</textarea>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <textarea id="methodology" name="methodology" rows="15" cols="80"
                class="form-control">{$post.methodology}</textarea>
        </div>
    </div>
