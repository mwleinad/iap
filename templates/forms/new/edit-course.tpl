    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <select name="modality" id="modality"  class="form-control">
                <option value="Local" {if $post.modality == "Local"} selected="selected"{/if}>Escolar (Presencial)</option>
                <option value="Online" {if $post.modality == "Online"} selected="selected"{/if}>No Escolar (En Línea)</option>
