<form id="editInstitutionForm" name="editInstitutionForm" method="post">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="ubication_long">Dirección:</label>
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="jefeOficina">Jefe de Oficina::</label>
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="respServiciosEscolares">Responsable de Serv. Escolares:</label>
        ...
        <div class="col-md-6">
            <label for="directorAcademico">Director(a) Académico:</label>
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="jefeServiciosEscolares">Jefe de Servicios Escolares:</label>
